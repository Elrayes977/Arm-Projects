...
ErrorState_t MNVIC_enEnableInterrupt(u8 Copy_u8IRQNumber);
ErrorState_t MNVIC_enDisableInterrupt(u8 Copy_u8IRQNumber);
ErrorState_t MNVIC_enSetPendingFlag(u8 Copy_u8IRQNumber);
ErrorState_t MNVIC_enClearPendingFlag(u8 Copy_u8IRQNumber);
ErrorState_t MNVIC_enGetActiveFlag(u8 Copy_u8IRQNumber,u8 *ptrResult);
