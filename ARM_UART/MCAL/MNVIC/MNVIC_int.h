...
ErrorState_t MNVIC_enDisableInterrupt(NVIC_Prority_t Copy_u8IRQNumber);
ErrorState_t MNVIC_enSetPendingFlag(NVIC_Prority_t Copy_u8IRQNumber);
ErrorState_t MNVIC_enClearPendingFlag(NVIC_Prority_t Copy_u8IRQNumber);
ErrorState_t MNVIC_enGetActiveFlag(NVIC_Prority_t Copy_u8IRQNumber,u8 *ptrResult);
